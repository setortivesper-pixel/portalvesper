...
window.portalData.manuais = [
  ...
  { titulo: "Uso AnyDesk", descricao: "Passo a passo para conectar no AnyDesk.", categoria: "TI", departamento: "Tecnologia da Informação", data: "2026-07-31", arquivo: "https://drive.google.com/file/d/1_cdPBleAIZkAE_rcPlUfXDS31nktR3nn/view?usp=sharing", palavrasChave: ["anydesk", "acesso remoto", "ti"] },
  { titulo: "Lightshot", descricao: "Passo a passo para utilizar os atalhos do Lightshot.", categoria: "TI", departamento: "Tecnologia da Informação", data: "2026-07-31", arquivo: "https://drive.google.com/file/d/1RjwyIc2XQujL5BlbImsGZzO0Nf4POuRI/view?usp=sharing", palavrasChave: ["lightshot", "atalhos", "captura de tela", "ti"] },
  ...
  { titulo: "ABMControl", descricao: "Procedimento para vincular motoristas aos veículos no sistema ABMControl.", categoria: "Operacional", departamento: "Operação", data: "2026-08-04", arquivo: "https://docs.google.com/document/d/1YUIFH5vAT_9Q17e4N8KSDPJNCwivl95o/edit?usp=drive_link&ouid=109244154480955470366&rtpof=true&sd=true", palavrasChave: ["abmcontrol", "motoristas", "veículos", "operação"] },
